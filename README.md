This was/is an experiment to see if I could get LLMs to write a book, which is too large to fit in the context window (while still having room for output and discussion).
